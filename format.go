...
/*
"Magic" constants for transforming integer div n/10, n/100 etc.
...
func divmod6(n uint64) (quo, rem uint64) {
	...
	return (n * d6) >> e6, n - (n*d6)>>e6*1000000
}
