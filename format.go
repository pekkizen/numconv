...
const exp = 35
const d10 = (1<<exp)/10 + 1
const d100 = (1<<exp)/100 + 1

// (n * d100) >> exp == n/100 for n <= 1.07e9 ~ 2^30
// (n * d10) >> exp == n/10 for n <= 5.36e9 ~ 2^32.3
// For exp = 35, d10 = 3435973837 ~ 2^31.7
// For any exp, n cannot exceed d10 or d100 much.
// exp = 35, n > 2^32.3 -> (n * d10) overflows uint64.
